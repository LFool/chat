...
int pack_msg(int action, Message *msg, int sockfd, int msgbytes)
{
    ...
    case VIPMEMBER:
    {
        ...
        printf("\033[5;14H             欢迎订制   ONLINE会员         \n");
        printf("\033[6;14H                                           \n");
    ...
    case SENDBQ:
    {
        ...
        printf("\033[5;14H          ONLINE表情包、聊得就是表情      \n");
        printf("\033[6;14H                                          \n");
        printf("\033[7;14H                                          \n");
        printf("\033[8;14H                                          \n");
        printf("\033[9;14H                                          \n");
    ...
    case SENDDY:
    {
        ...
        while (1)
        {
            ...
            if (num >= 1 && num <= 6)
            {
                ...
                {
                case 1:
                    strcpy(msg->msg, "外面侯着,老夫在上课");
                    break;
                case 2:
                    strcpy(msg->msg, "我有四个兄弟,叫东北F4");
                    break;
                case 3:
                    strcpy(msg->msg, "快点啊，等的我花都谢了");
                    break;
                case 4:
                    strcpy(msg->msg, "您所呼叫的用户已牛逼,sorry...");
                    break;
                case 5:
                    strcpy(msg->msg, "哟,是哪个妖风把您给上线了");
                    break;
                case 6:
                    strcpy(msg->msg, "看我小眼神行事,哈哈");
                    break;
                }
                msg->activity = 2;
                sleep(1);
