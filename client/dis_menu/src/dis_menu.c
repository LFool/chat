...
void loading_dis()
{
    ...
    printf("\033[17;49H｜＊                        ｜\n");
    printf("\033[18;50H^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n");
    printf("\033[19;50H ONLINE  Linux网络聊天室\n");
...
void help_dis()
{
    printf("\033[5;14H           ＊    谢谢使用ONLINE聊天室＊      \n");
    usleep(SIZE);
    ...
    usleep(SIZE);
    printf("\033[11;14H       你还可以加入  ONLINE 会员             \n");
    usleep(SIZE);
    printf("\033[12;14H       独享禁言、解禁、踢人等隐藏功能        \n");
    usleep(SIZE);
    printf("\033[13;14H                  开发人员信息               \n");
    usleep(SIZE);
    printf("\033[14;14H                     LFool                  \n");
    usleep(SIZE);
    printf("\033[15;14H                    ONLINE V1.0              \n");
    sleep(6);
    printf("\033[5;14H                                             \n");
    printf("\033[6;14H                                             \n");
    printf("\033[7;14H                                             \n");
...
void user_dis()
{
    ...
    printf("\033[4;12H｜^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^｜     LFool……    ｜ ｜     ｜   NAME:                  ｜\n");
    printf("\033[5;12H｜                                                   ｜                ｜ ｜(^_^)｜                          ｜\n");
    printf("\033[6;12H｜                                                   ｜    今日天气    ｜ ｜_____｜   PPID:        赞:       ｜\n");
    printf("\033[7;12H｜                                                   ｜                ｜                                    ｜\n");
    printf("\033[8;12H｜                                                   ｜   宜昌:晴      ｜ 个性签名: 这个人很懒,什么都没留下  ｜\n");
    printf("\033[9;12H｜                                                   ｜ 10～24度(微风) ＊－－－－－－－－－－－－－－－－－－＊\n");
    printf("\033[10;12H｜                                                   ｜                ｜                                    ｜\n");
    printf("\033[11;12H｜                                                   ｜ 适宜:睡觉、看剧｜                                    ｜\n");
    printf("\033[12;12H｜                                                   ｜    ________    ｜                                    ｜\n");
    printf("\033[13;12H｜                                                   ｜   /________\\   ｜                                    ｜\n");
    printf("\033[14;12H｜                                                   ｜   |        |   ｜                                    ｜\n");
    printf("\033[15;12H｜                                                   ｜   |   哈   |   ｜                                    ｜\n");
    printf("\033[16;12H｜___________________________________________________｜   |   哈   |   ｜                                    ｜\n");
    printf("\033[17;12H＊                                                   ＊   |   哈   |   ｜                                    ｜\n");
    printf("\033[18;12H｜                                                   ｜   |________|   ｜                                    ｜\n");
    printf("\033[19;12H＊___________________________________________________＊   \\________/   ＊____________________________________＊\n");
    printf("\033[20;12H｜                                                   ｜                ｜                                    ｜\n");
    printf("\033[21;12H｜   ＊群聊(ACH)               ＊私聊(PCH)           ｜  哈哈哈哈哈    ｜                                    ｜\n");
    printf("\033[22;12H｜                                                   ｜     嘿嘿嘿嘿…… ｜                                    ｜\n");
    printf("\033[23;12H｜   ＊刷出在线好友(DIS)       ＊HELP(HLP)           ｜                ｜                                    ｜\n");
    printf("\033[24;12H｜                                                   ｜      (^_^)     ｜                                    ｜\n");
    printf("\033[25;12H｜   ＊文件传输(SFS)           ＊查看聊天记录(SJL)   ｜                ｜                                    ｜\n");
...
void superuser_dis()
{
    ...
    printf("\033[19;12H＊___________________________________________________＊   \\________/   ＊____________________________________＊\n");
    printf("\033[20;12H｜                                                   ｜                ｜                                    ｜\n");
    printf("\033[21;12H｜   ＊群聊(ACH)     ＊私聊(PCH)     ＊点赞(ZAN)     ｜  哈哈哈哈哈    ｜＊刷出在线好友(DIS)  ＊帮助(HLP)    ｜\n");
    printf("\033[22;12H｜                                                   ｜     嘿嘿嘿嘿…… ｜                                    ｜\n");
